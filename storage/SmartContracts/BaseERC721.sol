...
contract $className is ERC721Enumerable, Ownable {
    uint256 public mintPrice = $mintPrice ether;
    uint256 public preSaleMintPrice = $preSaleMintPrice ether;

    uint256 private reserveAtATime = $reserveAtTime;
    uint256 private reservedCount = 0;
    uint256 private maxReserveCount = $reserveCount;
    ...
    uint256 public maximumMintSupply = $totalCount;
    uint256 public maximumAllowedTokensPerPurchase = $totalCount;
    ...
    constructor(string memory baseURI) ERC721("$collectionName", "$collectionSymbol") {
        setBaseURI(baseURI);
    }
